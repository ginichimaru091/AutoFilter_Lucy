...
OWNER_ID = environ.get('OWNER_ID', '6626261440')
...
CHAT_GROUP = int(environ.get("CHAT_GROUP", "-1002293960755"))

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1577166444 6626261440').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002351995341').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '6626261440').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002286347766') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002354089595') # request channel id ( make sure bot is admin )
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://seriesflix099:flix@cluster0.qz3uq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "seriesflix099")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Hurted_by_everyone') # owner username without @

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002317219651')) #Log channel id ( make sure bot is admin )
DUMP_CHNL = int(environ.get('DUMP_CHNL', '-1002280036883'))

# Verify
VERIFY = bool(environ.get('VERIFY', True)) # Verification On ( True ) / Off ( False )
HOWTOVERIFY = environ.get('HOWTOVERIFY', 'https://t.me/+i83vXOkM08YwOTA9') # How to open tutorial link for verification

# Others
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'inshorturl.com')
SHORTLINK_API = environ.get('SHORTLINK_API', 'a8d16f6b51ca516d6688c9a19fc611aefedc6647')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', True))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
BOT_USERNAME = environ.get("BOT_USERNAME", "Lucy_Auto_Filter_Bot")
BOT_NAME = environ.get("BOT_NAME", "𝐋ᴜᴄʏ")
BOT_ID = environ.get("BOT_ID", "7655494412")
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/team_DinoFlix')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/+i83vXOkM08YwOTA9') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : ᴄᴏᴅᴇғʟɪx ʙᴏᴛs')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+U_XCblafSWk3NmQ1') #Support group link ( make sure bot is admin )
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002351995341')).split()]
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002317219651'))
